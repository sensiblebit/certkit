...
- Add Ed25519 PKCS#12 container test, `EncodePKCS12Legacy` pointer-form test, and OpenSSH→JKS cross-format round-trip — fills iteration 2 gaps for Ed25519 normalization through all container paths ([`PLACEHOLDER`])
