...
Configured hooks: `no-commit-to-branch`, `branch-name`, `commit-message` (commit-msg stage), `goimports`, `go-fix`, `wasm`, `go-vet`, `go-build`, `go-test`, `golangci-lint`, `prettier`, `vitest`, `wrangler build`, `markdownlint`.
