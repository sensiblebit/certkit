...
Configured hooks: `no-commit-to-branch`, `branch-name`, `commit-message` (commit-msg stage), `goimports`, `go-fix`, `wasm`, `go-vet`, `golangci-lint`, `go-build`, `go-test`, `prettier`, `vitest`, `wrangler build`, `markdownlint`.
