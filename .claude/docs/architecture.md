...
- `bundleplan_existing.go` — Inspects existing bundle leaves, recognizes selected CA certificates from managed manifests, and fingerprints contents to reject stale plans and symlinked output bundles.
